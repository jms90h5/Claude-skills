package com.teracloud.streams.hbase.sample;
...
public class KeyHelper {
	 ...
	 * @return
	 */
	@Function(name="makeKey", namespace = "com.teracloud.streams.hbase.sample", description = " A custom key generation function.  ")
