...
import com.teracloud.streams.topology.context.ContextProperties;
...
import com.teracloud.streams.topology.function.UnaryOperator;
import com.teracloud.streams.topology.logic.Value;
import com.teracloud.streams.topology.messaging.kafka.KafkaConsumer;
import com.teracloud.streams.topology.messaging.kafka.KafkaProducer;
import com.teracloud.streams.topology.tuple.Message;
import com.teracloud.streams.topology.tuple.SimpleMessage;
 ...
 * and a Kafka cluster:
 * <ul>
 * <li>{@link com.teracloud.streams.topology.messaging.kafka.KafkaConsumer KafkaConsumer} - subscribe to Kafka topics and create streams of messages.</li>
 * <li>{@link com.teracloud.streams.topology.messaging.kafka.KafkaProducer KafkaProducer} - publish streams of messages to Kafka topics.</li>
 * </ul>
 * <p>
 ...
 * </ul>
 * <p>
 * Required Streams environment variables:
 * <ul>
 ...
 * <LI>
 * {@code java -cp functionalsamples.jar:../../../com.teracloud.streams.topology/lib/com.teracloud.streams.topology.jar:$STREAMS_INSTALL/lib/com.ibm.streams.operator.samples.jar
 *  kafka.KafkaSample CONTEXT_TYPE
 * } - Run directly from the command line.
 * </LI>
 * <i>CONTEXT_TYPE</i> is one of:
 * <UL>
 * <LI>{@code DISTRIBUTED} - Run as an Streams distributed application.</LI>
 * <LI>{@code STANDALONE} - Run as an Streams standalone application.</LI>
...
public class KafkaSample {
    ...
    private String kafkaToolkitVer;
    ...
    private Map<String,Object> createProducerConfig() {
        Map<String,Object> props = new HashMap<>();
        if (kafkaToolkitVer.startsWith("2.0")) {
    ...
    private void identifyKafkaToolkitVer() throws Exception {
        String tkloc = System.getenv("STREAMS_INSTALL")
                        + "/toolkits/com.teracloud.streams.kafka";
