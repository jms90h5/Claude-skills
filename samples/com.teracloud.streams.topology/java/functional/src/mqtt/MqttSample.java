...
import com.teracloud.streams.topology.messaging.mqtt.MqttStreams;
 ...
 * <p>
 * {@link com.teracloud.streams.topology.messaging.mqtt.MqttStreams MqttStreams} is
    ...
    public void publishSubscribe(String contextType) throws Exception {
        ...
        if (contextType.contains("DISTRIBUTED")) {
            System.out.println("\nSee the job's PE console logs for the topology output.\n"
                    + "Use Streams Console or streamtool.  e.g.,\n"
                    ...
                    + "\n");
            System.out.println("Cancel the job using Streams Console or streamtool. e.g.,\n"
