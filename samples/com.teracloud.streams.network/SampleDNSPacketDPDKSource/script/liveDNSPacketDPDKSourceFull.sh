...
[[ -d $toolkitDirectory/com.teracloud.streams.network/impl/src/source/dpdk/build/lib ]] || die "sorry, could not find DPDK glue library directory '$toolkitDirectory/com.teracloud.streams.network/impl/src/source/dpdk/build/lib'"
[[ -f $toolkitDirectory/com.teracloud.streams.network/impl/src/source/dpdk/build/lib/libstreams_source.a ]] || die "sorry, could not find DPDK glue library '$toolkitDirectory/com.teracloud.streams.network/impl/src/source/dpdk/build/lib/libstreams_source.a'"
