...
1) You have to import the dpsHelper package as done below. This helper package is part of 
   the dps toolkit ($STREAMS_INSTALL/toolkits/com.teracloud.streams.dps/impl/java/lib/dps-helper.jar). This jar file contains the
...
2) Please refer to the <library> sections in the operator model XML file for this Java primitive operator.
   ...
   b) Second <library> section contains a libPath element that points to the 
      ...
      dps toolkit directory: $STREAMS_INSTALL/toolkits/com.teracloud.streams.dps/impl/java/lib/dps-helper.jar
...
import com.teracloud.streams.dps.*;
import com.teracloud.streams.dl.*;
