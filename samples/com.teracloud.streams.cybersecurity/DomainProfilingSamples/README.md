...
This sample demonstrates how you can use the DomainProfiling operator from the `com.teracloud.streams.cybersecurity` toolkit.
...
Alternative you can submit the `./output/DomainProfilingBasic_Output/com.teracloud.streams.cybersecurity.sample.DomainProfilingBasic.sab` file to your Streams instance.
